    ...
    <SafeAreaView style={styles.containerSafe}>
      ...
      <TouchableOpacity style={styles.chevronButton} onPress={handleSair}>
        ...
        <View style={styles.buttons}>
          <View style={styles.buttonSelecionarArquivo}>
                    <TouchableOpacity style={styles.buttonEntregar} onPress={handleSelecionarArquivo}>

                    <View style={styles.SelecionarFlexBox}> 
                      <Text style={styles.buttonTextSelecionar}>Selecionar Arquivo</Text>
                      <AntDesign name="paperclip" size={20} color="#545759" />
                    </View>
                    </TouchableOpacity>
                  </View>
